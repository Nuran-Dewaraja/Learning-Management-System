...
const StudentETPanel = () => {
  ...
  return (
    <div style={{ maxWidth: '65%', margin: '0 auto', padding: '20px' }}>
      <h3 className="mx-3">Electrical Technician Course Resources</h3>
      <p className="text-secondary mx-3">Access lecture materials, quizzes, assessments, and other resources.</p>      <div style={{display: 'flex',flexWrap: 'wrap',justifyContent: 'flex-start'}}>
        {etContent.map((item) => (
