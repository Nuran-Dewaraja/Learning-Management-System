...
const StudentAutoPanel = () => {
  ...
  const fetchAutoContent = async () => {
    try {
      ...
      console.error('Error fetching Automobile content:', error);
    }
  };
  ...
  return (
    <div style={{ maxWidth: '65%', margin: '0 auto', padding: '20px' }}>
      <h3 className="mx-3">Automobile Course Resources</h3>
...
export default StudentAutoPanel;
